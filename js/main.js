...
function searchFunction() {
	...
	document.getElementById('myInput').onkeypress=function(e){
		if(e.keyCode==13){
			...
			var x = document.getElementById("sfunction");
...
$(document).ready(function () {
	...
	$('.content__mobile-tabs1-menu li').each( function() {
		$(this).attr('data-value', $(this).text().toLowerCase());
	});

	$('.content__mobile-tabs1-menu li').on('click', function() {
		var text = $(this).text();
		var item = $(this);
		var id = item.closest('.content__mobile-tabs1').attr('id');
		$('#'+id).find('.content__mobile-tabs1-btn input').val(text);
	});

	$('.content__mobile-tabs2-menu li').each( function() {
		$(this).attr('data-value', $(this).text().toLowerCase());
	});

	$('.content__mobile-tabs2-menu li').on('click', function() {
		var text = $(this).text();
		var item = $(this);
		var id = item.closest('.content__mobile-tabs2').attr('id');
		$('#'+id).find('.content__mobile-tabs2-btn input').val(text);
	});
